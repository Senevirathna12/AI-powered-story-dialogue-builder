...
import { toast } from 'sonner';
import { BookOpen, MessageSquare, Sparkles, TrendingUp, Wand2, Loader2, Copy, Download } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const handleGenerate = async () => {
    ...
    setTimeout(() => {
      ...
      toast.success(`${mode === 'story' ? 'Story' : 'Dialogue'} generated successfully!`);
    }, 2500);
  };
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-4">
                <Card className="border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg">
                  <CardHeader className="pb-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Choose from popular {mode === 'story' ? 'story' : 'dialogue'} templates to get started quickly
                    </p>
                  </CardHeader>
              ...
              <div className="col-span-4">
                <Card className="border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg h-full">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <CardTitle className="flex items-center space-x-2 text-lg">
                        ...
                        <span>Generated {mode === 'story' ? 'Story' : 'Dialogue'}</span>
                      </CardTitle>
                      {content && (
                  ...
                  <CardContent>
                    <div className="bg-gray-50 dark:bg-gray-800/90 rounded-lg p-6 h-[calc(65vh-2rem)] overflow-y-auto custom-scrollbar">
                      {isGenerating ? (
