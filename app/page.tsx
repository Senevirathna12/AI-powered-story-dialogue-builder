...
export default function Home() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      await signIn();
      toast.success('Signed in successfully! Welcome to AI Story Generator!');
        ...
        <div className="relative px-6 py-16 sm:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              >
                <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/50 hover:shadow-lg transition-shadow duration-200 backdrop-blur-sm">
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/50 dark:to-purple-900/50 hover:shadow-lg transition-shadow duration-200 backdrop-blur-sm">
                  <CardContent className="p-6 text-center">
                    <motion.div
